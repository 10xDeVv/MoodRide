...
CREATE TABLE scenic_score_tiles (
...
CREATE INDEX idx_scenic_h3 ON scenic_score_tiles(h3_index);
CREATE INDEX idx_scenic_score ON scenic_score_tiles(scenic_score DESC);
CREATE INDEX idx_scenic_geom ON scenic_score_tiles USING GIST(geometry);

-- Constraint to ensure valid scores
ALTER TABLE scenic_score_tiles ADD CONSTRAINT scenic_score_range 
