...
CREATE INDEX idx_road_geom ON road_segments USING GIST(geometry);
CREATE INDEX idx_road_h3_tile ON road_segments(h3_tile_index);
CREATE INDEX idx_road_osm_way ON road_segments(osm_way_id);
CREATE INDEX idx_road_type ON road_segments(road_type);

-- Constraint to ensure valid geometries
ALTER TABLE road_segments ADD CONSTRAINT valid_road_geometry 
