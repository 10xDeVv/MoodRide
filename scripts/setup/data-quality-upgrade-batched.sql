...
--
-- Notes:
-- - Targets only tiles not already at scoring_version '2.6-raster-data-quality-upgrade-national-batched'.
...
\echo Building national target batches for 2.6...
...
WHERE COALESCE(sst.scoring_version, '') <> '2.6-raster-data-quality-upgrade-national-batched';
...
WHERE scoring_version = '2.6-raster-data-quality-upgrade-national-batched';
